                ...
                <section className="pt-32 pb-16 md:pt-40 md:pb-20 px-4 md:px-6 max-w-[1600px] mx-auto min-h-[80vh]">
                    ...
                    <div className="columns-1 sm:columns-2 md:columns-3 gap-6 space-y-6">
                        {allGalleryImages.map((img, index) => (
                            ...
                            >
                                {/* Auto height trick for next/image inside masonry requires standard img tag or relative wrapper with intrinsic ratios, but since we want masonry, an intrinsic responsive approach using next/image with layout responsive or styled is best. */}
                ...
                <AnimatePresence>
                    {selectedImage && (
                        ...
                        >
                            ...
                            >
                                {/* Render image/video responsively with object fit contain */}
